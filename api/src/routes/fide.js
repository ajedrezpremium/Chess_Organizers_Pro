...
router.post('/submit/:tournamentId', authenticate, async (req, res) => {
  try {
    ...
    const trfContent = serializeTRF({
      ...
      chiefArbiter: tournament.chief_arbiter,
      deputyArbiter: tournament.deputy_arbiter,
      deputyArbiter2: tournament.deputy_arbiter_2,
      tournamentDirector: tournament.tournament_director,
      address: tournament.location_address,
      roundTime: tournament.round_time,
